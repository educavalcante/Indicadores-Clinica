...
<head>
    ...
    <title>Fechados Hoje - Sistema de Suporte</title>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where fechado >= current_date order by fechado" ; // consulta do registro atual
                                                $cont = 1;
