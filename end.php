...
<!--        <script src="assets/plugins/jQuery/jquery-3.6.0.min.js" type="text/javascript"></script> -->
        ...
        =====================================================================-->
         <script>
                ...
                // notification
                <? if  ((isset($_SESSION["ID_CPC"])) && (isset($_POST['password']))) { ?>
                ...
                setTimeout(function () {
                    ...
                    toastr.success('CPC SAPI WEB', 'Bem Vindo ao Sistema CPC');
        ...
        //bar chart
                ...
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: ["Janeiro", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
                        datasets: [
                            {
