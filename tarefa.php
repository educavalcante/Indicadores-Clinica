...
//  $sql = "SELECT * FROM clienteaberto where funcionario "
//  if (!isset($_GET['func']))
//     $_GET['func'] = $_POST['CODIGO'];
//     $sql = "SELECT * FROM clienteaberto where funcionario =".$_GET['func'] ; // consulta do registro atual
...
<head>
    ...
    <title>Listagem de Tarefas - Suporte CPC</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Listagem de Tarefas de <?echo $_SESSION['NOME']?></h1>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                                <? 
                                                $sql = "select * from clienteaberto where funcionario = '".$_SESSION['APELIDO']."' order by funcionario"; // consulta do registro atual
                                                $cont = 1;
