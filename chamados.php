...
<head>
    ...
    <title>Chamados - Sistema de Suporte</title>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where data >= '2022-11-17' and status in (0,4,5,6) and funcionario <> '' order by data desc" ; // consulta do registro atual
                                                $cont = 1;
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where data >= '2022-11-17' and funcionario is null order by data" ; // consulta do registro atual
                                                $cont = 1;
                                                foreach ($suporte->query($sql) as $rowinterno) { 
