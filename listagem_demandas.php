                            ...
                            <div class="panel-body">                            
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select usuarios.a_nome,inicio,final,ativtipo.descricao, atividade.observacao, atividade.indice from atividade
                                                inner join ativtipo on (atividade.ativtipo =ativtipo.indice)
                                                inner join usuarios on (usuarios.codigo = atividade.funcionario)
                                                where final >= '1.3.2023' and final < '1.4.2023' and ativtipo.folha = 'S'
                                                order by 1,2 "; // consulta do registro atual
                                                $cont = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <span class="label-success label label-default">Aceito</span>
                                                </td>  
                                                <td>                                                
                                                <a href="listagem_demandas.php?indice=<? echo $rowinterno['INDICE'] ?>">
