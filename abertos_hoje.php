...
<head>
    ...
    <title>Abertos Hoje - Sistema de Suporte</title>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where data >= current_date order by data" ; // consulta do registro atual
                                                $cont = 1;
