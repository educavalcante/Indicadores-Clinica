...
<!-- =============================================== -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <h1> Assistência</h1>
                        <small> Funções para assistir ao paciente</small>
            ...
            <!-- Main content -->
                <section class="content">
                    ...
                    <?
                    $sql = "select titulo,comando,imagem from sapibotoes where grupo like 'Assist%' order by ordem";

                    foreach ($fatura->query($sql) as $row) 
                    {                            
                    ?>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                            <a href="index.php?p=<? print $row['COMANDO'] ?>" >
                                    <? echo '<img width=200 height=133 src="data:image/bmp;base64,'.base64_encode( $row['IMAGEM'] ).'"/><br>' ?>
                    
                                    <center><? print $row['TITULO']; ?></center>
                            </a>
                        </div>
                        <? } if (1==2) { ?>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
