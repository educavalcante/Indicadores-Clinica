...
$sql = "select * from chamadaatual('192.168.250.20')" ; // consulta do registro atual
try {
    $erro = '';
...
h1 {
    ...
    <body class="hold-transition sidebar-collapse sidebar-mini">
                        ...
                        <div class="col-sm-12 col-md-8">
                            ...
                            <div class="panel panel-bd">
                                ...
                                <div class="panel-body">
                                    <br><br><br><br>
                                    <h1><center><font size="100" face="Arial"><? print $descricao ?><p><br><? print $local ?></font></center></h1>
                                    <br><br><br><br>
                                    </div>
                                    <div class="panel-footer"><h2>
                                    <? print date('d/m/y H:i', strtotime($data)) ?></h2>
                                    </div>
                                </div>
                            </div>
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="panel panel-inverse">
                                        ...
                                        <ol>
                                        <?
                                            $sql = "select skip 1 * from chamadaanterior('192.168.250.20')" ; // consulta do registro atual
        ...
        <div class="pull-right hidden-xs"><? print $erro ?> <b>Version</b> 1.0</div>
    ...
    <? if ($local != '') include  'speak/fala.php'; ?>