...
<head>
    ...
    <title>Chamados Nível 1 - Sistema de Suporte</title>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where nivel = 'N' and status in(0,4,6,5) and data >= '2022-11-17' order by data desc" ; // consulta do registro atual
                                                $cont = 1;
