...
<head>
    ...
    <title>Chamados +30 dias - Sistema de Suporte</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Chamados com mais de 30 dias</h1>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where data <= current_date -30  and status in (0,4,5,6,7,8,9) order by data desc" ; // consulta do registro atual
                                                $cont = 1;
