    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
              <form method="post" action="info_clientes.php">
                <div class="row">
                    <!-- Form controls -->
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body">                                
                                    <div class="col-sm-3 form-group">
                                        <label>Código</label>
                                        <input type="text" class="form-control" value="<? echo $row['EMPRESA_CODIGO'] ?>" name="empresa_codigo">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label>Razão Social</label>
                                        <input type="text" class="form-control" value="<? echo $row['EMPRESA_RAZAOSOCIAL'] ?>" name="empresa_razaosocial">
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label>Condição</label>
                                        <input type="text" class="form-control" value="<? echo $row['EMPRESA_CONDICAO'] ?>" name="empresa_condicao">
                                    </div>                                     
                                    <div class="col-sm-3 form-group">
                                        <label>CNPJ</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_CNPJ']?>" name="empresa_cnpj">
                                    </div>                                                                                                            
                                    <div class="col-sm-3 form-group">
                                        <label>Endereço</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_ENDERECO']?>" name="empresa_endereco">
                                    </div>
                                    <div class="col-sm-3 form-group ">
                                        <label>Bairro</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_BAIRRO']?>" name="empresa_bairro">
                                    </div>
                                    <div class="col-sm-3 form-group ">
                                        <label>Cidade</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_CIDADE']?>" name="empresa_cidade">
                                    </div>
                                    <div class="col-sm-1 form-group ">
                                        <label>UF</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_UF']?>" name="empresa_uf">
                                    </div>
                                    <div class="col-sm-2 form-group ">
                                        <label>CEP</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_CEP']?>" name="empresa_cep">
                                    </div>
                                    <div class="col-sm-2 form-group ">
                                        <label>Contato Ass em:</label>
                                        <input type="text" class="form-control"  value="<?echo date(" d/m/Y H:i",
                                            strtotime($row['CONTRATO']));?>">
                                    </div>
                                    <div class="col-sm-2 form-group ">
                                        <label>Telefone</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_TELEFONE']?>" name="empresa_telefone">
                                    </div>
                                    <div class="col-sm-2 form-group ">
                                        <label>Diretor</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_DIRETOR']?>" name="empresa_diretor">
                                    </div>
                                    <div class="col-sm-3 form-group ">
                                        <label>E-mail responsável</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_EMAIL']?>" name="empresa_email">
                                    </div>
                                    <div class="col-sm-3 form-group ">
                                        <label>E-mail TI</label>
                                        <input type="text" class="form-control"  value="<?echo $row['EMPRESA_EMAIL_TI']?>" name="empresa_email_ti">
                                    </div>                                    
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body">
                                <div class="col-sm-3 form-group ">
                                    ...
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_TIPOACESSO']?>" name="empresa_tipoacesso">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Endereço IP</label>
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_ENDACESSO']?>" name="empresa_endacesso">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Usuário</label>
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_USERSISTEMA']?>" name="empresa_usersistema">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Senha de Acesso</label>
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_SENHAACESSO']?>" name="empresa_senhaacesso">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Código de Usuário</label>
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_CODUSERSIS']?>" name="empresa_codusersis">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Senha</label>
                                    <input type="text" class="form-control" value="<?echo $row['EMPRESA_SENHASIS']?>" name="empresa_senhasis">
                                </div>
                                <div class="col-sm-3 form-group ">
                                ...
                                <div class="col-sm-3 form-group ">
                                    <label>Senha</label>
                                    <input type="text" class="form-control" value="senha_cpd">
                                </div>
                                <div class="col-sm-3 form-group ">
                                ...
                                <div class="col-sm-3 form-group ">
                                    ...
                                    <input type="text" class="form-control" value="<?echo $row['LINKACESSOREMOTO']?>">
                                </div>
                                <div class="col-sm-3 form-group ">
                                    <label>Adicionado por:</label>
                                    <select class="form-control" id="exampleSelect1" 
                                        size="1">
                                        <option value="<?echo $row['CONSULTOR']?>"><?echo $row['CONSULTOR']?></option>
                                ...
                                <div class="col-sm-12 form-group form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea" rows="8" ><? echo $row['EMPRESA_LIMITE']; ?></textarea >
                                        </div>
                                    </div>
                                </div>
                            </div>
