...
if (!isset($_SESSION['filtro']))
    ...
    $_SESSION['de']  = date("d/m/y");
if (!isset($_SESSION['ate']))
    $_SESSION['ate'] = date("d/m/y");
$filtrotipo = "";
$filtroclasse = "";
$filtrostatus = "";
$filtrosql    = "";
...
$sql = "select LVL_NUMEROLAUDO, LVL_CODIGOCPS, LVL_CODPAC, LVL_PACIENTE, LVL_TIPOATD, LVL_TIPOPROC, LVL_DTSOLICITACAO, LVL_PROCEDIMENTO, LVL_STATUS, LVL_SITUACAO, LVL_CPSLAUDOITEM , LVL_DICOM from laudoviewlista('where cpslaudo2.data between ''".str_replace('/','.',$_SESSION['de'])."'' and ''".str_replace('/','.',$_SESSION['ate'])." 23:59:59''','order by cpslaudo2.data',1)".$filtrotipo.$filtroclasse.$filtrostatus.$filtrosql;
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Laudos</h1>
                            <small>Listagem de Pacientes</small>
                        </div>
                    </section>
                    <!-- Main content -->
                              ...
                              <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    ?>
                                        ...
                                        <td><input type="text" value="<? print $row['LVL_PACIENTE'] ?>" class="form-control" readonly></td>
                                       ...
                                       <td>
                                       <!-- <a href="index.php?p=laudar&id=<? print $row['LVL_CPSLAUDOITEM'] ?>" class="border-gray"><i class="fa fa-inbox"></i>Laudar</a>-->
                                       <? if (1==1) { ?>
                                       <div class="navbar-custom-menu">
                                            ...
                                            <ul class="menu">
                                                <li>
                                                <a href="index.php?p=laudohist&id=<? print $row['LVL_CODPAC'] ?>"  target="_blank" class="border-gray"><i class="fa fa-inbox"></i>Historico</a>
                                                </li>
                                            </ul>                                            
                                            <ul class="menu">
                                                <li>
                                                <a href="pacszip.php?patid=<? print $row['LVL_DICOM'] ?>"  target="_blank" class="border-gray"><i class="fa fa-inbox"></i>Pacs Zip</a>
                                                </li>
                                            </ul>
                                            <ul class="menu">
                                                <li>
                                                <a href="pacsjpg.php?patid=<? print $row['LVL_DICOM'] ?>"  target="_blank" class="border-gray"><i class="fa fa-inbox"></i>Pacs JPG</a>
                                                </li>
                                            </ul>
                                            <ul class="menu">
                                                <li>
                                                <a href="index.php?p=imagens&tipo=cpslaudo<? print $row['LVL_NUMEROLAUDO'] ?>"  target="_blank" class="border-gray"><i class="fa fa-inbox"></i>Documentos Anexadas</a>
                                                </li>
                                            </ul>
                                            </li>                                            
