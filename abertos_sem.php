...
<head>
    ...
    <title>Abertos Nesta Semana - Sistema de Suporte</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Chamados Abertos Nesta Semana</h1>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from clientefechado where data >= current_date -7 order by data desc" ; // consulta do registro atual
                                                $cont = 1;
