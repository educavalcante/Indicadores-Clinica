            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1> Painéis</h1>
                        <small> Paineis do Usuário</small>
                    </div>
                </section>
            <!-- Main content -->
                <section class="content">
                    <div class="row">
                    <?  
                        $sql = "select * from usercartoes(".$_SESSION['ID_CPC'].",'SAPI')";
                            ...
                            <div class="panel panel-bd cardbox">
                                <div class="panel-body">
                                    <div class="statistic-box">
                                        <h2><span class="count-number"><? print $row['QTDE'] ?></span>
                                        </h2>
                                    </div>
                                    <div class="items pull-left">
                                        <i class="fa <? print $row['ICONE'] ?> fa-2x"></i>
                                        <h4><? print $row['DESCRICAO'] ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
