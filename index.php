...
if (isset($_POST['senha']))
{
    $sql = "SELECT * FROM LOGIN_APP(0".$_POST['codigo'].",'".$_POST['senha']."')" ; // consulta do registro atual
        foreach ($fatura->query($sql) as $rowlogin) {
...
<head>
    ...
    <title>Indicadores de Gestão</title>
...
<body class="hold-transition sidebar-mini">
                    ...
                    <?php
                        if (isset($_SESSION['ID']) && $_SESSION['ID'] == '1') {
                            $menu = '<li class="treeview">
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="loginSuporte.php">Adicionar</a></li>
                                            <li><a href="listagem_demandas.php">Listagem de Demandas</a></li>
                                        </ul>
                                    </li>';
                        } else {
                            $menu = '<li class="treeview">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd cardbox">
                            <div class="panel-body" onclick="location.href='chamados.php'">
                                ...
                                <div class="items pull-left">
                                    ...
                                    <h4 id="abertos">Marcados Hoje</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <? 
                                                $sql = "select * from indicador_lista1" ; // consulta do registro atual
                                                $cont = 1;
                                                foreach ($fatura->query($sql) as $rowinterno) {                                             
                                                ?>
                                            <tr>
                                                <td>
                                                    <? echo $cont; ?>
                                                ...
                                                <td>
                                                    <a href="fechamento_suporte.php?cod=<? echo $rowinterno['A_MEDICOS']; ?>"
                                                        target="_suporte"> 
                                                        <? echo $rowinterno['A_MEDICOS']; ?>
                                                    </a>
                                                </td>
                                                <td>
                                                     <? echo $rowinterno['MEDICOS']; ?>                                                    
                                                </td>
                                                <td>
                                                    <? echo $rowinterno['QTDE']; ?>
                                                </td>
    ...
    <script>
        ...
        //bar chart
        <?
            $sql = "SELECT * FROM GRAFICOINDICADOR('AGENDA')" ; // consulta do GRAFICO AGENDAS
            foreach($fatura-> query($sql) as $rowgraf) { } //Abre a consulta uma linha só
        ?>
        ...
        //line chart
        <?
            $sql = "SELECT * FROM GRAFICOINDICADOR('CONVENIO')" ; // consulta do registro atual
            foreach ($fatura->query($sql) as $rowgraf2) {} //Abre a consulta uma linha só
        ?>
