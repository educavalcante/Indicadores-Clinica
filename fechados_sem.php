...
<head>
    ...
    <title>Fechados Nesta Semana - Sistema de Suporte</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    <h1>Chamados Fechados Nesta Semana</h1>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tarefa"
                                        ...
                                        <tbody>
                                            <?                                                 
                                                $sql = "select * from clientefechado where fechado >= current_date -7 and status in (3,1,2) order by fechado desc" ; // consulta do registro atual
                                                $cont = 1;
